...
- Installed editions check stable GitHub releases, download in the app, and let you choose when to restart. Portable editions open the official release page.
