...
- 一键将文件、选中的代码或 Git 差异加入上下文，发送前可展开检查。支持的 CLI 可直接粘贴截图或添加图片。
...
文本附件单个限 1 MB、总计 4 MB；图片单个限 10 MB、总计 20 MB。图片入口依据 CLI 实际能力开放：2026-09-08 检查到稳定版 Grok 1.0.13 尚未提供 ACP 图片输入，界面会说明原因并保留草稿。音频输入尚未实现。运行 npm 脚本需要安装 Node.js。当前提供 Windows 版本，macOS/Linux 的打包与终端集成尚未实现。“检查 Grok Build 更新”更新的是官方 CLI。
